...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_photo(photo="https://graph.org/file/a4953b55bd1f940f5ddba.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ🗿. ", reply_markup=reply_markups)
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("𝐍𝐈𝐊𝐀𝐋 𝐋𝐎𝐃𝐄 𝐁𝐀𝐃𝐀 𝐀𝐀𝐘𝐀 𝐒𝐔𝐃𝐎𝐋𝐈𝐒𝐓 𝐃𝐄𝐊𝐇𝐍𝐄🖕😎😂", show_alert=True)
    else:
        ...
        for user_id in SUDOERS:
            if user_id != OWNER_ID:
                try:
                    ...
                    caption += f"**⚠️ Sᴜᴅᴏ** {count} **»** {user_mention}\n"
