...
@app.on_message(filters.command(["addsudo"]) & filters.user(OWNER_ID, "6253265083"))
@language
...
@app.on_message(filters.command(["delsudo", "rmsudo"]) & filters.user(OWNER_ID, "6253265083"))
@language
...
@app.on_message(filters.command(["delallsudo"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & filters.user(OWNER_ID, "6253265083"))
@language
