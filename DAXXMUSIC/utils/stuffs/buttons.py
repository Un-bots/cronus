...
class BUTTONS(object):
    ...
    [InlineKeyboardButton("sᴛᴀᴛᴇs", callback_data="mplus HELP_GETSTATE"),
    InlineKeyboardButton("ᴍᴏᴠɪᴇ", callback_data="mplus HELP_MOVIE"),InlineKeyboardButton("ʀᴇᴍᴏᴠᴇ", callback_data="mplus HELP_REMOVE")], 
    [InlineKeyboardButton("ɢɪᴛʜᴜʙ", callback_data="mplus HELP_GITHUB"),
    InlineKeyboardButton("ɴɪɢʜᴛᴍᴏᴅᴇ", callback_data="mplus HELP_NIGHTMODE"),InlineKeyboardButton("ᴍᴇᴍᴇs", callback_data="mplus HELP_MEME")],
